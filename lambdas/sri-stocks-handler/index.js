...
const handler = async (event) => {
    ...
    try {
        ...
        if (method === 'POST') {
            ...
            const { production_zone_id, grain_type, campaign, initial_stock, sold_delivered, livestock_consumption, seeds, extruder_own, extruder_exchange, exchanges, committed_sales } = body;
